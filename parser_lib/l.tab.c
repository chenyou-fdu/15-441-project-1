...
static const flex_int16_t yy_base[20] =
    {   0,
        0,    0,   17,   18,    0,   12,    0,   18,   18,   18,
       18,   18,   18,   18,    0,   11,    0,   18,   12
    } ;

static const flex_int16_t yy_def[20] =
    {   0,
       18,    1,   18,   18,   19,   18,   19,   18,   18,   18,
       18,   18,   18,   18,   19,   18,   16,    0,   18
    } ;

static const flex_int16_t yy_nxt[31] =
    {   0,
        4,    5,    4,    6,    7,    8,    9,   10,   11,   12,
       13,   14,   17,   15,   16,   17,   18,    3,   18,   18,
